...
<body class="bg-secondary a">
  ...
  <div id="usuarios" class="container"><br>
        <h3 class="h3">Registro de clientes</h3><br>
        <div class="container ">
              <div class="row justify-content-center m-5">
                <div class="col  mt-3 mx-3 ">
                  <div class="card" style="width:230px">
                     <img class="card-img-top " src="https://sistemasmicrocontrolados.com/imagenes/userAdd.png" alt="User Add" style="width:100%">
                     ...
                     <div class="card-body"> <!--Use .card-title to add card titles to any heading element. The .card-text class is used to remove bottom margins for a <p> element if it is the last child (or the only one) inside .card-body. The .card-link class adds a blue color to any link, and a hover effect. -->
                         <h5 class="card-title text-center">Add client</h5>
                         <p class="card-text"></p>
                ...
                <div class="col  mt-3 mx-3">
                  <div class="card" style="width:230px">
                     <img class="card-img-top" src="https://sistemasmicrocontrolados.com/imagenes/userEdit.png" alt="Card image" style="width:100%">
                     <div class="card-body">
                         <h5 class="card-title text-center">Edit client</h5>
                         <p class="card-text"></p>
                ...
                <div class="col  mt-3 mx-3">
                  <div class="card" style="width:230px">
                     <img class="card-img-top" src="https://sistemasmicrocontrolados.com/imagenes/userDelete.png" alt="Card image" style="width:100%">
                     <div class="card-body">
