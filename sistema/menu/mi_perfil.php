...
<html>
  ...
  <style type="text/css">
     body{
      background-image: url(https://sistemasmicrocontrolados.com/imagenes/CIS.jpg);
  	...
  	<div id="registros" class="container "><br>
      	...
      	<div class="container sm-5 d-flex justify-content-center my-5 h5">
			 		...
			 		<div class="card rounded border border-success text-white bg-info mb-3 " style="width: 28rem;">
					  <img src="https://sistemasmicrocontrolados.com/imagenes/aragon.jpg" class="card-img-top rounded-circle border border-danger"  width="240" height="240"alt="...">
