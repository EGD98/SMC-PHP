...
session_start();
 ...
 if ($varsesion == null || $varsesion = ''){
  echo "No tienes autorizacion, si eres usuario inicia sesion.  esto es lo que tiene la variable $varsesion";
  die();
...
<body class="bg-secondary">
  ...
  <!-- Finish Container-->  
    <div class="container">
      <div class="row">
        <div class="col-4 "><img class="original" src="https://sistemasmicrocontrolados.com/imagenes/door2.jpg" /></div>
        <div class="col-8 baby">
          <div class="col-7 text-center">
             <br>
            <a>DEVELOPED BY MEMBERS OF THE IDEA GROUP</a>
          </div>
      </div>
    </div>
