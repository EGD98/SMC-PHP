...
require_once ('./confddbb.php');
    ...
    if($conexion->connect_errno){
        ...
        $querys = " SELECT  * FROM espacios WHERE nombre_habitacion like '%$busqueda%' or lugares like '%$busqueda%' ";
      /*  $querys = " SELECT espacios.id_espacios, espacios.nombre_habitacion, espacios.tipo_habitacion, 
                    tipo_habitacion.nombre, tipo_habitacion.id FROM espacios, tipo_habitacion
                    WHERE espacios.nombre_habitacion like '%$busqueda%' or tipo_habitacion.nombre like '%$busqueda%'
                      ";
           */
