...
<html>
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://sistemasmicrocontrolados.com/imagenes/gt_icon.ico">
    <!-- caracteres-->
    <meta charset="utf-8">
...
<body >
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mr-auto ">
        <li class="nav-item active">
          <a class="nav-link" href="deleteSpace.php"><strong>Eliminar Espacios</strong> <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
  ...
  <!-- Finish Menu Gigaticket-->
    <!-- Start alert status-->
    <div class="container" id="alertDS">
  ...
  <!-- Start Container edit Client-->
    ...
    <div class="container text-dark m-2">
      <!-- Modal -->
      <div class="modal fade  " id="deleteSModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="deleteSModalLabel" aria-hidden="true">
        <div class="modal-dialog  ">
          <div class="modal-content bg-danger border-dark">
            <div class="modal-header">
              <h5 class="modal-title" id="deleteSModalLabel">Eliminar Espacio</h5>
              ...
              <form method="POST" action="#" class="needs-validation my-2" novalidate>
                <div class="row justify-content-center ">
                  <div class="col-sm-5">
                    ...
                    <input type="hidden" name="id_deleteS" id="id_deleteS" class="">
                    </div>                     
                  </div>                   
                </div>
              </form>
              <h4>¿Estas seguro que quieres <strong>ELIMINAR</strong> este Espacio?</h4>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-dark" data-dismiss="modal">No</button>
            <button type="submit" class="btn btn-outline-light  " name="eliminarS" id="eliminarS">  
              Eliminar Espacio
            </button>
          </div>
        </div>
...
<script type="text/javascript" src="../js/deleteSpace.js"></script>
</body>
</html>